...
function youtubeUrlParser(url) {
  ...
  var html = `<style>body,html{margin: 0;}</style><iframe width=100% height=100% src="https://www.youtube.com/embed/${videoId}?autoplay=1&cc_load_policy=1&rel=0&showinfo=0"frameborder="0" allow="autoplay" allowfullscreen></iframe>`;
